...
export const TRELLIS_1_0_4_TEMPLATE_SHA256 = "acff3770ac8c30c896edd621996cf29a4761a0b993478659e4fa2cc445c7c2d5";

export const TRELLIS_1_0_4_LIMITS = {
...
export const TRELLIS_1_0_4_NOTICES = {
...
export function trellisArtifactNotice(path: string): string {
  return TRELLIS_1_0_4_NOTICES.artifact.replace("{path}", path);
}

/**
 * Literal golden payload captured from the frozen Trellis 1.0.4 renderer.
 ...
 */
export const V01_TRELLIS_1_0_4_PAYLOAD = `## Trellis Task Context
